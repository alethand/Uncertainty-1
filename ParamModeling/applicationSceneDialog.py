...
class applicationSceneDialog(wx.Dialog):

    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=u"应用场景", pos=wx.DefaultPosition, size=wx.Size(500, 300),
...
if __name__ == '__main__':
    app = wx.App(False)
    frame = applicationSceneDialog(None)
    frame.Show()
    app.MainLoop()