...
def buildoushidistance(snb,cog_p, inh_p, output1, input_v1):
    ...
    axes1.clear()
    axes1.boxplot(d)
    axes1.set(ylabel='Euclidean distance', title='Simulation of Euclidean distance')
...
def buildmshidistance(snb,cog_p, inh_p, output1, input_v1):
    ...
    d = x
    axes1.boxplot(d)
    axes1.set(ylabel='Markov distance', title='Simulation of Markov distance')
...
def buildqiebixuefudistance(snb,cog_p, inh_p, output1, input_v1):
    ...
    print "========================"
    axes1.boxplot(d)
    axes1.set(ylabel='Chebyshev distance', title='Simulation of Chebyshev distance')
...
def buildmanhadundistance(snb,cog_p, inh_p, output1, input_v1):
    ...
    print "========================"
    axes1.boxplot(d)
    axes1.set(ylabel='Manhattan  distance', title='Simulation of Manhattan distance')
